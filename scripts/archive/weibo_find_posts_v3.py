...
db_dbname = "weibo_firewall_db"
db_collectionname = "posts_to_check"

weibo_apikey_module.sayhello()

# Grab 100 posts every six minutes to get 1000 per hour
accessfriends_query = "https://api.weibo.com/2/statuses/friends_timeline.json?count=100&access_token=ATOKEN"
thisquery = weibo_apikey_module.addtoken(accessfriends_query, "ATOKEN")

data = urlopen(thisquery).read()
print data
# data
response = loads(data)
...
db = conn[db_dbname]
collection = db[db_collectionname]
