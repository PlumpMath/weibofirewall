...
db = conn[weibomodule.dbname]
collection_checklog = db[weibomodule.collection_checklog]
collection_postids_live = db[weibomodule.collection_postids_live]
...
# grab statuses of friends
thisquery = weibomodule.accessfriends()
